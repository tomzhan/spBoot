...
public class RedisService {
    ...
    public   <T> T getJson(String key, Class<T> clazz) {
        return JsonUtil.parseObject(stringRedisTemplate.boundValueOps(key).get(), clazz);
    }
    ...
    public  <T> Map<String, T> mget(String key, Class<T> clazz){
        BoundHashOperations<Object, String, T> boundHashOperations = redisTemplate.boundHashOps(key);
     ...
     * @return
     */
    public  <T> T getMap(Object key, Class<T> clazz){
        BoundHashOperations<Object, String, String> boundHashOperations = redisTemplate.boundHashOps(key);
